...
<li class="nav-item">
    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <form class="text-center" method="post" action="suspendServlet" name="adduserform">
            <div class="md-form">
            ...
            <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" name="adduser" value="add new user" >Suspend user</button>
