...
<li class="nav-item">
 ...
 <li class="nav-item"><a class="nav-link" href="loginpage.jsp">logout (${loggedInUser.getUsername()})</a></li>
         ...
         <div class="card" style="left: 25%; width: 500px ; height: 200px; " >
            <div class="card-body px-lg-5 pt-0">
                                            <p pos="center" style="color: green;">${successString}  </p>
                            <p pos="center" style="color: red;">${errorString}  </p>
        <form class="text-center" method="post" action="resetServlet" name="adduserform">
            <div class="md-form">
            ...
            <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" name="adduser" value="add new user" >Reset password</button>
