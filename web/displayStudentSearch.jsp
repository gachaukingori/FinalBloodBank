...
<th style="width: 14%"> Admission</th>
        ...
        <%
            ...
            String sql = "Select * from STUDENTDONORS where admission = ? or schoolname= ? or level_of_study =?  or fname=? or lname=? or age =?";
            ...
            pstatement.setString(6, search);
            

            resultSet = pstatement.executeQuery();
            while (resultSet.next()) {
                studentList.add(resultSet.getString(1));
                studentList.add(resultSet.getString(2));
                studentList.add(resultSet.getString(3));
                studentList.add(resultSet.getString(4));
                studentList.add(resultSet.getString(5));
                studentList.add(resultSet.getString(6));
                studentList.add(resultSet.getInt(7));
