...
<body>
      <div class="container">
            ...
            <div class="text-center">
                <h1 style="font-family:cursive,Times,serif; color: #8a0303; text-align: center "> Welcome to County Blood Bank System <img src="images/heart.png"   style="height: 25px; width: 25px;" ><br>
                admin page</h1>
